...
public class JsoupDownloadParser extends DownloadParser {

	private final static Logger log = LogManager.getLogger(JsoupDownloadParser.class);
	
	public JsoupDownloadParser(int id, int chapter, int page) throws IOException {
